...
export const metadata: Metadata = { title: 'Datenschutzerklaerung', robots: { index: false } };
export default function Page() {
  return (
    <section className="pt-36 pb-24"><Container>
      <h1 className="font-display text-4xl font-black text-white">Datenschutzerklaerung</h1>
